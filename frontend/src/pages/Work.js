...
// import foundersImage from '../assets/founders.jpg'; // Adjust the path as needed
...
const Work = () => {
  return (
    <WorkContainer>
      <Section>
        <p>
          In <EmphasizedText>May 2024</EmphasizedText>, I co-founded{' '}
        ...
        <Paragraph>
          Responsible for the management, maintenance, and creation of a cross-platform RESTful API. Responsible for writing, managing, and maintaining the CMS admin panel.
        </Paragraph>
      </Section>
      <Section>
